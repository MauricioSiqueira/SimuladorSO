...
- [x] Ter o SDK do c# instalado na máquina
- [x] Ter o c# devkit instalado no vscode ( caso esteja rodando no vscode, em outras IDEs como rider e VsCommunity não é necessário)
